...
CHAMPION_PREPROCESSOR_PATH: str = "fraudguard/model/build_{timestamp}/preprocessor.pkl"
...
CHAMPION_LATEST_PREPROCESSOR_PATH: str = "fraudguard/model/champion/preprocessor.pkl"
CHAMPION_LATEST_REFERENCE_PATH: str = "fraudguard/model/champion/reference.csv"
DRIFT_REPORT_S3_PREFIX: str = "fraudguard/monitoring/drift_reports"
